    ...
    <main class="profile-page">
        <section class="">
          ...
          ">
            ...
            <div class="left-0 right-0 w-full pointer-events-none overflow-hidden h-70-px"
                        ...
                        <div class="flex flex-wrap justify-center">
                            <div class="flex">
                                <form method="post" class="deposit" action="{{route('portfolio.increaseBalance')}}">
                                    @csrf
                                    <input class="w-29 h-6 text-sm" type="text" name="amount" id="amount"
                        ...
                        <div class="">
                            <div class="flex justify-center py-4 lg:pt-4 pt-8">
                                <div class="mr-4 p-3 text-center">
                                    <span
                                        class="text-xl font-bold block uppercase tracking-wide text-blueGray-600">33</span><span
                                        class="text-sm text-blueGray-400">Trades made</span>
                                </div>
                                <div class="mr-4 p-3 text-center">
                                    <span class="text-xl font-bold block uppercase tracking-wide text-blueGray-600">{{ Auth::user()->cash_balance }}$</span><span
                                        class="text-sm text-blueGray-400">Account balance</span>
                                </div>
                                <div class="lg:mr-4 p-3 text-center">
                                    <span
                                        class="text-xl font-bold block uppercase tracking-wide text-blueGray-600">33</span><span
                                        class="text-sm text-blueGray-400">Profit</span>
                                </div>
                            </div>
                        </div>
                    </div>
